...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None, mask_cond=None,
            ...
            if kwargs.get('save_attn_maps', False):
                for name, module in self.model.model.diffusion_model.named_modules():
                    ...
                    if module_name == 'CrossAttention' and 'attn2' in name:
                        ...
                        if mask_cond['is_use']:
                            self.attn_maps[name+'_extra'].append(module.attn_extra)
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            ...
            e_t_uncond, e_t = self.model.apply_model(x_in, t_in, c_in, mask_cond=mask_cond).chunk(2)
